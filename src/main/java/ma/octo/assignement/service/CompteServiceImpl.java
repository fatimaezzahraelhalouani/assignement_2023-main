...
public class CompteServiceImpl implements CompteService {
    ...
    {
        Utilisateur utilisateur = utilisateurRepository.findByUsername(compteRequestDto.getUsername());

        if (utilisateur == null)
        {
            throw new UtilisateurNonExistantException("Cet utilisateur "+ compteRequestDto.getUsername()+" n'existe pas");
        }
        ...
        Compte compte = compteRepository.save(CompteMapper.RequestCompte(compteRequestDto, utilisateur));
